...
module.exports = {
	controls: {
		...
		permission: 2,
		usage: "setup",
		description: "Ejecuta un proceso interactivo de configuración general",
		image: "images/Setup.gif",
		examples: "El bot te hará una pregunta esperando una respuesta para la configuración del bot hasta que todo esté listo.",
		enabled: true,
